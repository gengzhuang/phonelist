    ...
    $(function() {
    	$('#menuTree').tree({
            ...
            onClick : function(node) {
            	if (node.attributes) {
            		addTab(node.text,(node.attributes.substring(0,4) != "http") ? '${path }'+ node.attributes : node.attributes,node.iconCls);
            	}
            },
...
<body>
    ...
    <div id="index_layout">
        ...
        <div data-options="region:'south',border:false" style="height: 30px;line-height:30px; overflow: hidden;text-align: center;background-color: #eee" >Copyright © 2016 power by <a href="http://www." target="_blank">EASY</a></div>
    </div>
