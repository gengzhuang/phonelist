...
<script type="text/javascript" src="${staticPath }/static/easyUtil.js" charset="utf-8"></script>
<script type="text/javascript" src="${staticPath }/static/LodopFuncs.js" charset="utf-8"></script>
<!-- [扩展样式] -->
